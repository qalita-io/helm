...
| frontend.image.tag | string | `1.7.0` | QALITA Frontend Image Tag |
...
| backend.image.tag | string | `1.7.0` | QALITA Backend Image Tag |
...
| agent.image.tag | string | `1.7.0-db` | QALITA Agent Image Tag |
...
| doc.image.tag | string | `1.7.0` | QALITA Doc Image Tag |
